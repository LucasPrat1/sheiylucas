...
export default function Home() {
  return (
    <main>
      ...
      <section id='countdown' className='containerSection p-4 lg:p-8'>
        <Countdown />
      </section>

      <section id='cards' className='w-full py-4 px-6 lg:px-16 grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-16'>

        <div id='card' className='flex flex-col items-center bg-slate-200 rounded-xl ring-2 ring-slate-300 shadow-lg p-3'>
          <Image src={anillos} alt="icono anillos" />
